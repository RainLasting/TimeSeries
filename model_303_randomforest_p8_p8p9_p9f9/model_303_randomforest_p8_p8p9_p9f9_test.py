...
def main():
    ...
    parser.add_argument("--model_dir", type=str, default="./saved_models_xgbrf_clean")
    parser.add_argument("--output_excel", type=str, default="test_report_rf_clean.xlsx")
    ...
    model_types = ["p8", "p8p9", "p9f9"] # Only core models

    logger.info("Starting Inference (XGBRF Clean)...")
    ...
    for t in tqdm(days, desc="Testing"):
        ...
        for m_name in model_types:
            ...
            if X_feat is not None:
                ...
                raw_p = raw_p.astype(int) # ensure int type
        ...
        # 1. p8p9(Type 1) vs p9f9(Type 2/6) Conflict -> Prioritize p9f9
    ...
    print("\n" + "#"*40)
    print("FINAL TEST REPORT (XGBRF Clean)")
    print("#"*40)
